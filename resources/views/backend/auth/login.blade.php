...
<html lang="en">
    <head>
        ...
        <!-- Canonical SEO -->
        <link rel="canonical" href="{{ url('backend/auth') }}" />
        <!--  Social tags      -->
        <meta name="keywords" content="Login page For Coupon Backend">
        ...
        <meta itemprop="image" content="{{ url('public/backend/images') }}/synergylogo.png">
        <!-- Twitter Card data -->
        ...
        <meta name="twitter:image" content="{{ url('public/backend/images') }}/synergylogo.png">
        <!-- Open Graph data -->
        <meta property="fb:app_id" content="655968634437471">
        <meta property="og:title" content="Login page For Coupon Backend" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="{{ url('backend/auth') }}" />
        <meta property="og:image" content="{{ url('public/assets/images/slider/sl91/2.png') }}" />
            ...
            <div id="login_content">
                ...
                <div class="login-body">
                    <form method="post" action="" role="form" id="login" class="login-form fade-in-effect">
                        ...
                        <a href="{{ url('').'/forgot_password' }}" data-href="" id="super_forgotpassword" class="forgot-pass pull-right">Forgot Password?</a>
...
{	// Reveal Login form
    ...
    $("form#login .form-group:has(.form-control):first .form-control").focus();
        ...
        <script type="text/javascript">
var rec_login = "{{ url('recruiter/auth') }}";
var company_login = "{{ url('backend/auth/login/post') }}";
