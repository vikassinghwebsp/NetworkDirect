        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="card">
                <header class="card-heading ">
                    ...
                    <p>All Sub SubCategory List will show here</p>
                        ...
                        <table id="productsTable"  class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th data-orderable="false">Sub SubCategory Name</th>
                                    <th data-orderable="false">Sub SubCategory Description</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">{{ $i++ }}</th>
                                    <td>{{ (!empty($subcategory->subsubcat_name))?$subcategory->subsubcat_name:'' }}</td>
                                    <td>{{ (!empty($subcategory->subsubcat_description))?substr($subcategory->subsubcat_description,0,50):'' }}</td>
                                    <td>{{ (!empty($subcategory->cat))?substr($subcategory->cat,0,50):'' }}</td>
                                    <td>{{ (!empty($subcategory->subcat))?$subcategory->subcat:'' }}</td>
                                    <td>
                                        <div class="togglebutton">
                                            <label>
                                                <input data-attr="{{ $subcategory->status }}" data-id="{{ $subcategory->id }}" type="checkbox" class="toggle-info subsubactive" <?php if ($subcategory->status == 1) { ?>checked<?php } ?>>
                                            </label>
                                        </div>
                                    </td>
                                    <td>
                                        <nav class="btn-fab-group">
                                            ...
                                            <ul class="nav-sub">
                                                ...
                                                <li> <a href="{{ url('/backend/subSubCat/edit/'.$subcategory->parent_category) }}" data-toggle="tooltip" data-placement="top" title="Edit SubCategory" class="btn btn-blue btn-fab btn-fab-sm cat_et"><i class="zmdi zmdi-edit zmdi-hc-fw"></i></a></li>
                                                <li> <a data-href="{{ url('/backend/subcategory/rm/'.$subcategory->id) }}" href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="Remove SubCategory" class="btn btn-danger btn-fab btn-fab-sm subcat_rm"><i class="zmdi zmdi-delete"></i></a></li>
