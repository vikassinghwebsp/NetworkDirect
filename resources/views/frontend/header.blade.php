...
<html lang="en">
    <head>
        ...
        <!-- include the site stylesheet -->
        <link rel="stylesheet" href="{{ URL::asset('public/assets/css/icon-fonts.css')}}">
        <!-- include the site stylesheet -->
        ...
        <link rel="stylesheet" href="{{ URL::asset('public/assets/css/sky-forms.css')}}">
        <link rel="stylesheet" href="{{ URL::asset('public/assets/css/custom-sky-forms.css')}}">
        <link rel="stylesheet" href="{{ URL::asset('public/assets/css/shop.style.css')}}">
        <link rel="stylesheet" href="{{ URL::asset('public/assets/css/custom-jquery.steps.css')}}">
        <link rel="stylesheet" href="{{ URL::asset('public/assets/css/custom.css')}}">
        <link rel="stylesheet" href="{{ URL::asset('public/assets/css/jquery.fancybox.min.css')}}">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3">
                                    <div class="logo"><a href="{{ url('/') }}"><img src="{{ URL::asset('public/assets/images/logo.png')}}" class="img-responsive" alt="logo"></a></div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-2 hidden-xs">
                                    <div class="cart">
                                        <a href="{{ url('cart') }}" style="color:white;"> <i class="fa fa-shopping-cart fa-2x"><span>{{ (!empty(Cart::count())) ?Cart::count():'' }}</span></i></a>
                                    </div>

                                </div>
                                <div class="col-xs-12 col-sm-2 hidden-xs">
                                    <div class="sale">
                                        <img src="{{ URL::asset('public/assets/images/tag.png')}}">
                                    </div>             
                                </div>  
                            </div>
                        </div>
                                                            ...
                                                            foreach ($switches as $kicks) {
                                                                ...
                                                                <div class="mt-col-3">
                                                                    <div class="sub-dropcont">
                                                                        <a href="{{ url('/products/'.$kicks->category_id) }}"><strong class="title"><?php echo $kicks->category_name; ?></strong></a>
                                                                        <!-- mt col3 start here -->
                                                                        <?php
                                                                ...
                                                                <div class="mt-col-3">
                                                                    <div class="sub-dropcont">
                                                                        ...
                                                                        foreach ($subcat as $kicks) {
                                                                            ...
                                                                            <div class="sub-drop">
                                                                                <ul>
                                                                                    <li ><a href="{{ url('/subcatproducts/'.$kicks->subcategory_name) }}" ><?php echo $kicks->subcategory_name; ?></a></li>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form-horizontal" action="{{ url('signIn') }}" method="post" id="myForm">
