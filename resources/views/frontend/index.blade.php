...
<div id="pre-loader" class="loader-container">
    <div class="loader">
        <img src="{{ URL::asset('public/assets/images/rings.svg')}}" alt="loader">
    </div>
</div>
 <?php  //phpinfo();exit; ?>
<main id="mt-main">
                ...
                <div class="banner-frame toppadding-zero">
                    ...
                    <div class="banner-5 white wow fadeInLeft" data-wow-delay="0.1s">
                       <?php //var_dump($arrContent['topleft1']['url']);exit; ?>
                        <div class="sb1">
                            <div class="sb3"><a href="{{ (!empty($arrContent['topleft1']['url']))? $arrContent['topleft1']['url']:'' }}"><img src="{{ (!empty($arrContent['topleft1']['image']))? $arrContent['topleft1']['image']:'' }}" alt="image description"></a> </div>
                            <div class="sb4"><a href="{{ (!empty($arrContent['topleft2']['url']))? $arrContent['topleft2']['url']:'' }}"><img src="{{ (!empty($arrContent['topleft2']))? $arrContent['topleft2']['image']:'' }}" alt="image description"> </a></div>
                        </div>
                        <div class="sb2">
                            <a href="{{ (!empty($arrContent['topleft3']['url']))? $arrContent['topleft2']['url']:'' }}"> <img src="{{ (!empty($arrContent['topleft3']))? $arrContent['topleft3']['image']:'' }}" alt="image description"></a>
                    ...
                    <div class="banner-6 white wow fadeInRight" data-wow-delay="0.1s">
                        <div ><a href="{{ (!empty($arrContent['topmiddle']['url']))? $arrContent['topmiddle']['url']:'' }}"> <img src="{{ (!empty($arrContent['topmiddle']))? $arrContent['topmiddle']['image']:'' }}" alt="image description"></a></div>
                    ...
                    <div class="banner-box two">
                        ...
                        <div class="banner-7 right wow fadeInUp" data-wow-delay="0.1s">
                            <div ><a href="{{ (!empty($arrContent['topright1']['url']))? $arrContent['topright1']['url']:'' }}"> <img src="{{ (!empty($arrContent['topright1']))? $arrContent['topright1']['image']:'' }}" alt="image description"></a></div>
                            
                        </div><!-- banner 7 right end here -->
                        <!-- banner 8 start here -->
                        <div class="banner-8 wow fadeInDown" data-wow-delay="0.1s">
                            <div ><a href="{{ (!empty($arrContent['topright2']['url']))? $arrContent['topright2']['url']:'' }}"> <img src="{{ (!empty($arrContent['topright2']))? $arrContent['topright2']['image']:'' }}" alt="image description"></a></div>
                ...
                <div class="banner-frame mt-paddingsmzero">
                    ...
                    <div class="banner-box third wow fadeInLeft" data-wow-delay="0.1s">
                        ...
                        <div class="banner-12 right white wow fadeInUp" data-wow-delay="0.1s">
                            <img src="{{ (!empty($arrContent['middleleft1']))? $arrContent['middleleft1']['image']:'' }}" alt="image description">
                            
                        </div><!-- banner 12 right white end here -->
                        <!-- banner 13 right start here -->
                        <div class="banner-13 right wow fadeInDown" data-wow-delay="0.2s">
                            <img src="{{ (!empty($arrContent['middleleft2']))? $arrContent['middleleft2']['image']:'' }}" alt="image description">
                    ...
                    <div class="slider-7 wow fadeInRight" data-wow-delay="0.1s">
                        ...
                        <div class="slider banner-slider">
                            <!-- holder start here -->
                            <div class="s-holder">
                                <img src="{{ (!empty($arrContent['slider1']))? $arrContent['slider1']['image']:'' }}" alt="image description">
                                
                            </div><!-- holder end here -->
                            <!-- holder start here -->
                            <div class="s-holder">
                                <img src="{{ (!empty($arrContent['slider2']))? $arrContent['slider2']['image']:'' }}" alt="image description">
                                <div class="s-box">
                            ...
                            <!-- holder star here -->
                            <div class="s-holder">
                                <img src="{{ (!empty($arrContent['slider3']))? $arrContent['slider3']['image']:'' }}" alt="image description">
                                <div class="s-box">
                                    <strong class="s-title">FURNITURE DESIGNS IDEAS</strong>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab2">
                            ...
                            <div class="tabs-sliderlg">
                                <!-- slide start here -->
                                @foreach($arrContent['latest_products'] as $productData)
                                    ...
                                    <div class="mt-product1 large">
                                        <div class="box">
                                            <div class="b1">
                                                ...
                                                <div class="b2">
                                                    <a href="{{ url('/product-details/'.$productData->product_slug) }}"><img src="{{URL::asset('public/assets/images/products/thumb/' . $image)}}"  alt="image description"></a>
                                                    <ul class="links">
                                                        <li><a href="{{ url('/addCart/'.$productData->product_slug) }}"><i class="icon-handbag"></i><span>Add to Cart</span></a></li>
<!--                                                        <li><a href="#"><i class="icomoon icon-heart-empty"></i></a></li>-->
                                                        <li><a href="{{ URL::asset('public/assets/images/products/' . $image)}}" class="lightbox"><i class="icomoon icon-eye"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="txt">
                                            <strong class="title"><a href="{{ url('/product-details/'.$productData->product_slug) }}">{{ (!empty($productData->product_name))? substr($productData->product_name,0,30):''  }}</a></strong>
                ...
                <div class="banner-frame nospace wow fadeInUp" data-wow-delay="0.1s">
                    <!-- banner 9 start here -->
                    <div class="banner-9">
                        <img src="{{ (!empty($arrContent['bottomleft']))? $arrContent['bottomleft']['image']:'' }}" alt="image description">
                        <!-- <div class="holder">
                    ...
                    <div class="banner-10">
                        <img src="{{ (!empty($arrContent['bottommiddle']))? $arrContent['bottommiddle']['image']:'' }}" alt="image description">
                        <!--<div class="holder">
                    ...
                    <div class="banner-11">
                        <img src="{{ (!empty($arrContent['bottomright']))? $arrContent['bottomright']['image']:'' }}" alt="image description">
                        <!--<div class="holder">
                ...
                <div class="mt-producttabs style3 wow fadeInUp" data-wow-delay="0.1s">
                    <h2 class="heading">{{ $arrContent['title'] }}</h2>
                    <!-- tabs slider start here -->

                    
                    <div class="tabs-slider">
                        <!-- slide start here -->
                        @if(!empty($arrContent['frontCat']))
                    @foreach($arrContent['frontCat'] as $frontCat)
                        <div class="slide">
                            ...
                            <div class="mt-product1">
                                <div class="box">
                                    <div class="b1">
                                        <div class="b2">
                                            <a href="{{ url('/product-details/'.$frontCat->product_slug) }}"><img src="{{ URL::asset('public/assets/images/products/213x215/' . $image)}}"  alt="image description"></a>
                                            <span class="caption">
                                                <span class="new">new</span>
                                            </span>

                                            <ul class="links">
                                                <li><a href="{{ url('/addCart/'.$frontCat->product_slug) }}"><i class="icon-handbag"></i><span>Add to Cart</span></a></li>

                                                <li><a href="{{ URL::asset('public/assets/images/products/thumb/' . $image)}}" class="lightbox"><i class="icomoon icon-eye"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="txt">
                                    <strong class="title"><a href="{{ url('/product-details/'.$frontCat->product_slug) }}">{{ (!empty($frontCat->product_name))? substr($frontCat->product_name,0,30):''  }}</a></strong>
                                    <span class="price"><?php
                                                if (Session::get('money')) {
                                                    $userData = Session::get('money');
                                                    $curr = $userData[0]['currency'];
                ...
                <div class="mt-patners wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="patner-slider">
                        ...
                        @foreach($arrContent['allBrands'] as $brand)

                        <?php //var_dump($brand);exit;   ?>

                        <div class="slide">
                            <div class="box1">
                                <div class="box2"><a href="{{ (!empty($brand->brand_url))? $brand->brand_url :'' }}"><img src="{{ \App\library\Customlibrary::getBrandImage($brand->brand_image,'thumb') }}" width="110" height="22" alt="img"></a></div>
                            </div>
                        </div>
