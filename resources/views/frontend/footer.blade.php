            ...
            <div class="row">
                <div class="col-xs-12 col-sm-5 col-md-4 mt-paddingbottomxs">
                    ...
                    <div class="f-widget-about">
                        <div class="logo">
                            <a href="{{ url('/') }}"><img src="{{ URL::asset('public/assets/images/logo.png')}}" alt="logo"></a>
                        </div>
                ...
                <nav class="col-xs-12 col-sm-7 col-md-5 mt-paddingbottomxs">
                    ...
                    <div class="nav-widget-1">
                        ...
                        <ul class="list-unstyled f-widget-nav">
                            <li><a href="{{ url('/menuproducts/'.'CISCO SWITCHES') }}">CISCO SWITCHES</a></li>
                            <li><a href="{{ url('/menuproducts/'.'CISCO ROUTERS') }}">CISCO ROUTERS</a></li>
                            <li><a href="{{ url('/menuproducts/'.'CISCO SECURITY') }}">CISCO SECURITY</a></li>
                            <li><a href="{{ url('/menuproducts/'.'CISCO WIRELESS') }}">CISCO WIRELESS</a></li>
                            <li><a href="{{ url('/menuproducts/'.'CISCO ACCESSORIES') }}">CISCO ACCESSORIES</a></li>
                            <li><a href="{{ url('/menuproducts/'.'CISCO IP PHONES') }}">CISCO IP PHONES</a></li>
                            <li><a href="{{ url('/menuproducts/'.'CISCO MERAKI') }}">CISCO MERAKI</a></li>
                        </ul>
                    </div>
...
<!--                            <li><a href="#">Privacy Policy</a></li>
                    ...
                    if (Session::get('user')) {
                        ...
                        <div class="nav-widget-1">
                            ...
                            <ul class="list-unstyled f-widget-nav">
                                <li><a href="{{ url('myaccount/order-history') }}">My Account</a></li>
                ...
                <div class="col-xs-12 col-md-3 text-right hidden-sm">
                    ...
                    <div class="f-widget-newsletter">
                        ...
                        <div class="holder">
                            <form class="newsletter-form form2" action="{{ url('subscribe') }}" method="post">
                                <fieldset>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 text-right">
                    <div class="bank-card">
                        <img src="{{ URL::asset('public/assets/images/bank-card.png')}}" alt="bank-card">
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{ URL::asset('public/assets/js/jquery-migrate.min.js')}}"></script>
<script src="{{ URL::asset('public/assets/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script src="{{ URL::asset('public/assets/js/jquery.validate.min.js')}}"></script>
<!-- include jQuery -->

<script src="{{ URL::asset('public/assets/js/jquery.main.js')}}"></script>
<script src="{{ URL::asset('public/assets/js/page_login.js')}}"></script>
<script src="{{ URL::asset('public/assets/js/shop.app.js')}}"></script>
<script src="{{ URL::asset('public/assets/js/jquery.steps.js')}}"></script>
<script src="{{ URL::asset('public/assets/js/stepWizard.js')}}"></script>
<script src="{{ URL::asset('public/assets/js/product-quantity.js')}}"></script>

<script src="{{ URL::asset('public/assets/js/jquery.fancybox.min.js')}}"></script>
<script src="{{ URL::asset('public/assets/js/custom.js')}}"></script>
<script type="text/javascript" src="{{ URL::asset('public/assets/js/curry.min.js')}}"></script>
<script type="text/javascript" src="{{ URL::asset('public/assets/js/bootbox.min.js')}}"></script>
    ...
    $('document').ready(function () {
        ...
        $(function () {
            $('#my-element').curry({
                ...
                //console.log(rate);
                var APP_URL = {!! json_encode(url('curr')) !!}
                //alert(APP_URL);
                $.ajax({
                    type: "POST",
                    url: APP_URL,
...
<script>
    ...
    $(".formsubmitbuttons").click(function (event) {
        ...
        var BASE_URL = {!! json_encode(url('signIn')) !!}
