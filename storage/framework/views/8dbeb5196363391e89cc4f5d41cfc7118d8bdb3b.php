            ...
            <div class="col-xs-12">
                <header id="header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo e(url('backend/coupon')); ?>">Terms & Condition</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group label-floating is-empty">
                            ...
                            <input type="text" name="title" class="form-control" value="<?php echo e(!empty($arrContent['termsData'][0]->title)?$arrContent['termsData'][0]->title:''); ?>">
                        </div>
                        ...
                        <input type="hidden" name="terms_id" value="<?php echo e(!empty($arrContent['termsData'][0]->id)?$arrContent['termsData'][0]->id:''); ?>">
                        <div class="form-group label-floating is-empty">
                            <textarea class="form-control" name="description" rows="4" id="terms"><?php echo e(!empty($arrContent['termsData'][0]->description)?$arrContent['termsData'][0]->description:''); ?></textarea>
                        </div>
                    </div>
