...
<div class="content container">
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="checkout-steps">
            ...
            <a  href="<?php echo e(url('shipping')); ?>">1. Address</a></div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1">
                        <div class="panel-body">
                            <p>We accept following credit cards:&nbsp;<img class="d-inline-block align-middle" src="<?php echo e(URL::asset('public/assets/images/credit-cards.png')); ?>" style="width: 120px;" alt="Cerdit Cards"></p>

                            <div class="card-box">
                                <img src="assets/images/card.png" class="img-responsive" alt="">
                            </div>

                            <form class="credit-card row" method="POST" action="<?php echo route('addmoney.stripe'); ?>">
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <input class='form-control card-expiry-year' placeholder='YYYY' size='4' type='hidden' name='amount' value="<?php echo e($arrContent['amount']); ?>">
                                </div>
                                <div class="form-group col-sm-3">
                                    ...
                                    <input class="form-control" type="hidden" name="currency" placeholder="CVC" value="<?php
                                            ...
                                            ?>">
                                    <input class="form-control" type="hidden" name="vat" placeholder="CVC" value="<?php echo e($arrContent['vat']); ?>">
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="column text-lg">Tax: <span class="text-medium btn btn-success price"><?php
                                            ...
                                            ?> <?php echo e($arrContent['vat']); ?> </span>&nbsp;&nbsp;Total Price including VAT: <span class="text-medium btn btn-success price"><?php
                                            if (Session::get('money')) {
                                                $userData = Session::get('money');
                                                $curr = $userData[0]['currency'];
                                                $currency = strtolower($curr);
                                            ...
                                            ?> <?php echo e($arrContent['amount']); ?></span></div>
                                </div>
                            </form>
        ...
        <!--        <div class="checkout-footer margin-top-1x">
                    <div class="column"><a class="btn btn-outline-secondary" href="<?php echo e(url('shipping')); ?>"><i class="icon-arrow-left"></i><span class="hidden-xs-down">&nbsp;Back</span></a></div>
