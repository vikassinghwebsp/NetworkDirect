...
<div class="content container">
            ...
            if (Session::get('user')) {
                ...
                <div class="col-md-6 md-margin-bottom-40">
                    ...
                    <div class="billing-info-inputs checkbox-list">
                        ...
                        <input id="name" type="text" value="<?php echo e((!empty($invoiceAddress->full_name))?$invoiceAddress->full_name:''); ?>" placeholder="First Name" name="full_name" class="form-control required" >

                        <div class="row">
                            <div class="col-sm-6">
                                <input id="email" type="text" value="<?php echo e((!empty($invoiceAddress->email))?$invoiceAddress->email:''); ?>" placeholder="Email" name="email" class="form-control required email">

                            </div>
                            <div class="col-sm-6">
                                <input id="phone" type="tel" value="<?php echo e((!empty($invoiceAddress->mobile_no))?$invoiceAddress->mobile_no:''); ?>" placeholder="Phone" name="mobile_no" class="form-control required">
                            </div>
                        </div>
                        <input id="billingAddress" type="text" value="<?php echo e((!empty($invoiceAddress->address1))?$invoiceAddress->address1:''); ?>" placeholder="Address Line 1" name="address1" class="form-control required">
                        <input id="billingAddress2" type="text" value="<?php echo e((!empty($invoiceAddress->address2))?$invoiceAddress->address2:''); ?>" placeholder="Address Line 2" name="address2" class="form-control required">
                        <div class="row">
                            <div class="col-sm-6">
                                <input id="city" type="text" value="<?php echo e((!empty($invoiceAddress->city))?$invoiceAddress->city:''); ?>" placeholder="City" name="city" class="form-control required">
                            </div>
                            <div class="col-sm-6">
                                <input id="zip" type="text" value="<?php echo e((!empty($invoiceAddress->postal_code))?$invoiceAddress->postal_code:''); ?>" placeholder="Zip/Postal Code" name="postal_code" class="form-control required">
                            </div>
                        </div>
                        <input id="country" type="text" value="<?php echo e((!empty($invoiceAddress->country))?$invoiceAddress->country:''); ?>" placeholder="Address Line 2" name="country" class="form-control required">
                ...
                <div class="col-md-6">
                    ...
                    <form method="post" id="shipping_address" action="<?php echo e(url('payment')); ?>">
                        <div class="billing-info-inputs checkbox-list">
    ...
    <div class="add-to-cart-footer">
           ...
           <div class="checkout-footer">
                <div class="column"><a class="btn btn-outline-secondary" href="<?php echo e(url('cart')); ?>"><i class="icon-arrow-left"></i><span class="hidden-xs-down">&nbsp;Back To Cart</span></a></div>
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-md-6 control text-center">
                                        <div style="border-top: 1px solid #ccc;  font-size:85%" >
                                            ...
                                            <h4 class="widget-title">New User? <a href="<?php echo e(url('register')); ?>">Register Here</a></h4>
