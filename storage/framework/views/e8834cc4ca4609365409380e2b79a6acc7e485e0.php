                                            ...
                                            <li class="active"> 
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                            ...
                                                            ?>
                                                                      <!-- display none -->
                                                                <li class="active"><a href="#" class="color_dark d_block"><?php echo e((!empty($subCate->subcategory_name))?$subCate->subcategory_name:''); ?></a></li>
...
<?php //var_dump($arrContent['products'][0]->category_name);exit; ?>
            <div class="row margin-bottom-5">
                <div class="col-sm-4 result-category">
                    <h5><?php echo e($arrContent['products'][0]->subcategory_name); ?></h5>
