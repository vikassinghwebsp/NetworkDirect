                                                    ...
                                                    <li>
                                                        ...
                                                        <ul style="display:none;">
                                                            ...
                                                            foreach ($subCat as $subCate) {
                                                                ...
                                                                <li><a href="<?php echo e(url('/subcatproducts/'.$subCate->subcategory_name)); ?>" class="color_dark d_block"><?php echo e((!empty($subCate->subcategory_name))?$subCate->subcategory_name:''); ?></a></li>
        ...
        <div class="col-md-9">
            ...
            <div class="row margin-bottom-5">
                <div class="col-sm-4 result-category">
                    <h5><?php echo e((!empty($arrContent['products'][0]->category_name))?$arrContent['products'][0]->category_name:''); ?></h5>
                    <small class="shop-bg-red badge-results" style="top:-2px;"><?php echo e(count($arrContent['products'])); ?> Results Found</small>
                </div>
                <div class="col-sm-8">
                            ...
                            <div class="btn-group">
                                <div class="sort-listing">
                                  <ul class="list-inline ">
                                   ...
                                   <li><a href="<?php echo e(url('productprice',['cat_id'=>$cat_id,'sort'=>'ASC'])); ?>">Price -- Low to High</a></li>
                                      
                                 <li><a href="<?php echo e(url('productPrice',['cat_id'=>$cat_id,'sort'=>'DESC'])); ?>">Price -- High to Low</a></li>
