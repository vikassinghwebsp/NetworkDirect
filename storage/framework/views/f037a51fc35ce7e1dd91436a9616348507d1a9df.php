                        ...
                        <table id="productsTable"  class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e((!empty($couponData->full_name))?$couponData->full_name:''); ?></td>
                                    <td><?php echo e((!empty($couponData->email))?$couponData->email:''); ?></td>
                                    <td><?php echo e((!empty($couponData->mobile_no))?substr($couponData->mobile_no,0,50):''); ?></td>
                                    <td><?php echo e((!empty($couponData->address1))?$couponData->address1:''); ?></td>
                                    <td><?php echo e((!empty($couponData->city))?$couponData->city:''); ?></td>
