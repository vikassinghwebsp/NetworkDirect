            ...
            <div class="col-xs-12">
                <header id="header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo e(url('backend/banner')); ?>">Brand</a></li>
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="card">
                    <header class="card-heading p-b-0 ">
                        <h2 class="card-title">New Brand</h2>
...
<!--                        <div class="form-group label-floating is-empty">
                        ...
                        <div class="form-group is-empty">
                            <div class="input-group">
                                ...
                                <input type="file" class="form-control" placeholder="File Upload..." name="brand_image">
                                <div class="input-group">
